...
![Presentación del Flat Bar Chart](./img/flat_bar.gif)
...
2. **Pasar las Consultas de Entrada al Componente**:
   - Use el atributo `inputQueries` del componente Flat Bar Chart para pasar la cadena JSON de las consultas de entrada.
