...
3. **Ajoutez le Composant Générateur de Codes QR** :
   ...
   - Faites glisser le composant 'generateQrCode' et placez-le à l'emplacement de votre choix sur la page.
...
3. **Insérez le Composant Générateur de Codes QR** :
   ...
   - Faites glisser et déposez-le à l'emplacement souhaité sur la page du Contact.
...
**Remarque** : Assurez-vous d'avoir les autorisations nécessaires pour ajouter des composants aux pages dans Salesforce.
